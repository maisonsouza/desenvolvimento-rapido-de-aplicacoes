...
public class TarefaDAO {
    ...
    public TarefaDAO(DataSource dataSource) {
        try {
            ...
            System.out.println("Er*r*o: " + ex.getMessage());
    ...
    public List<Tarefa> listarTarefas(){
       ...
       try ( 
        ...
        while (rs.next()) {
           ...
           {
               data.setTime(rs.getDate("dataFinalizacao", Calendar.getInstance()));
    ...
    public Tarefa buscarTarefaPorId(Long id){
       ...
       try ( 
        ...
        if(rs.next()) {
           ...
           if(rs.getDate("dataFinalizacao") != null)
           {
               data.setTimeInMillis(rs.getDate("dataFinalizacao", Calendar.getInstance()).getTime());
               tarefa.setDataFinalizacao(data);
           }                 
        }
        return tarefa;
